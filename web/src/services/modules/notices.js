export function createNoticesApi(call) {
  return {
    ...
    importNotice: (payload) => call({ path: "/workbench/notices/import", method: "POST", data: payload }),
    fetchNoticeUrl: (payload) => call({ path: "/workbench/notices/fetch-url", method: "POST", data: payload }),
